//// Home Page for Around The Life (ATL) ////
    ...
    >
      ...
      <style>{`
        .app-header {
          ...
          right: 0;
          height: 60px;
          background-image: linear-gradient(to right, #d6e686ff , #fff);
          display: flex;
          align-items: center;
      ...
      <header className="app-header">
        {/* Project logo - left */}
        <div>
          <img src={ATLlogo} alt="Project Logo" className="logo" />
        </div>
        ...
        <div style={styles.headerProfile}>
          ...
          <div style={{ fontSize: "18px", fontWeight: 500, color: "#49828b" }}>
          ...
          {activePage === "dashboard" && (
            <>
              ...
              <div style={styles.dashboardLayout}>
                ...
                {/* Left Column - Documents + Common Documents */}
                <div style={styles.col}>
                  ...
                  <div style={{ ...styles.doccard, flex: 2 }} className="hover-doccard">
                    ...
                    <div style={styles.doccardContent}>
                      <p style={{ marginTop: "10px", color: "#49828b" }}>
                      ...
                      >
                        <a
                          ...
                          style={{ display: "flex", alignItems: "center", gap: "8px", color: "#49828b" }}
                        >
                          <img
                            src="https://img.icons8.com/?size=100&id=82790&format=png&color=49828b"
                            alt="file"
                            width="30"
                          />
                    ...
                    <div style={styles.comdoccardContent}>
                      <div style={styles.docList}>
                        <div style={styles.docRow}>
                          ...
                          <a href={userData.Project_Legal_Set} target="_blank" rel="noopener noreferrer" style={{ textDecoration: "none", color: "#49828b" }}>
                ...
                <div style={styles.rightCol}>
                  ...
                  <div style={styles.smallCard} className="hover-doccard">
                    <a href={userData.Referal} target="_blank" rel="noopener noreferrer" style={{ textDecoration: "none", color: "#49828b", fontSize: "18px", fontWeight: "600" }}>
          ...
          {showSuggestion && (
            <div style={styles.modelOverlay}>
              <div style={styles.modalBox}>
                ...
                <h3 style={{ textAlign: "center", color: "#49828b" }}>SUGGESTION BOX</h3>
          ...
          {showForm && (
            <div style={styles.modelOverlay}>
              <div style={styles.modalBox}>
                ...
                <h3 style={{ textAlign: " center", color: "#49828b" }}>CRM HELP TICKET</h3>
          ...
          {showKeyaUpdate && (
            <div style={styles.modelOverlay}>
              <div style={styles.updatemodalBox}>
                ...
                <h3 style={{ textAlign: "center", color: "#49828b" }}>KEYA UPDATE</h3>

                <div style={{ marginTop: "20px", fontSize: "15px", lineHeight: "1.5", color: "#49828b" }}>
